...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        # pass
        descriptions_dict = {0: 'This room has brown wall paper!',
                             1: 'This room has a red table.',
                             2: 'This room has a green floor!',
                             3: 'This room has white wallpaper.'
                             }
        return descriptions_dict[room_number]
    ...
    def get_input(self):
        ...
        res = []
        while True:
            interim_res = self.client_connection.recv(64).decode('utf-8')
            res.append(interim_res)
            if interim_res[-1] == '\n':
                break
        self.input_buffer = ''.join(res)
    ...
    def move(self, argument):
        ...
        * "west"
        ...
        try:
            self.room = rooms_dict[argument]
        except KeyError as e:
            self.output_buffer = e
        else:
